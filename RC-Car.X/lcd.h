...
#define LCD_I2C_ADR         0b0111100    // 7 bit slave-adress without r/w-bit
...
#ifdef I2C
#include "i2c_avr128db28.h"	// library for I2C-communication
...
#ifndef F_CPU
#define F_CPU 24000000UL  // Set your actual CPU frequency
#endif
#include <util/delay.h>   // Include delay library after defining F_CPU
